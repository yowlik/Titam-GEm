package com.kiloo.subwaysurfy.igraicas
...
import com.kiloo.subwaysurfy.Dataclassar
import com.kiloo.subwaysurfy.R
import com.kiloo.subwaysurfy.databinding.ActivityFazenDaBinding
...
class FazenDa : AppCompatActivity() {
    ...
    lateinit var bind: ActivityFazenDaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityFazenDaBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.kiloo.subwaysurfy"

        val myId: String? = Hawk.get(Dataclassar.MYID, "null")
        val instanceId: String? = Hawk.get(Dataclassar.INSTID, "null")
        ...
        val first = "http://"
        val second = "titaniumgem.xyz/go.php?to=2&"
